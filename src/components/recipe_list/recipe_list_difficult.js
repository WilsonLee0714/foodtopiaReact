      ...
      // <BrowserRouter>
        <React.Fragment>
          ...
          <div  className="container d-flex justify-content-center mt-5">
            ...
            <Link to="/difficult" className="category_link col-2">烹飪難度d</Link>
            <Link to="/time" className="category_link col-2">烹調時間</Link>
            
          </div >
          <main className="subCate_nav container d-flex justify-content-center">
            <Link className="mx-3" to="/country/1">簡單</Link>
            <Link className="mx-3" to="/country/3">中等</Link>
            <Link className="mx-3" to="/country/2">困難</Link>
