      ...
      // <BrowserRouter>
        <React.Fragment>
          ...
          <div  className="container d-flex justify-content-center mt-5">
            ...
            <Link to="/time" className="category_link col-2">烹調時間t</Link>
            
          </div >
          <main className="subCate_nav container d-flex justify-content-center">
            <Link className="mx-3" to="/country/1">15分鐘</Link>
            <Link className="mx-3" to="/country/2">30分鐘</Link>
            <Link className="mx-3" to="/country/3">45分鐘</Link>
            <Link className="mx-3" to="/country/4">60分鐘</Link>
          </main>
          {/* <div className="container d-flex justify-content-center mt-5">
