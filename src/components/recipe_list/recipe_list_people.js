...
import Product_slider from './recipe_filter/recipe_list_people/product_slider.js';
import Product_slider_right from './recipe_filter/recipe_list_people/product_slider_right.js';
import Product_slider_buttom from './recipe_filter/recipe_list_people/product_slider_buttom.js';
      ...
      // <BrowserRouter>
        <React.Fragment>
          ...
          <div  className="container d-flex justify-content-center mt-5">
            ...
            <Link to="/serving" className="category_link col-2">選擇人數p</Link>
          ...
          <Link className="mx-3" to="/country/1">1人份</Link>
            <Link className="mx-3" to="/country/2">2人份</Link>
            <Link className="mx-3" to="/country/3">3人份</Link>
            <Link className="mx-3" to="/country/4">4人份</Link>
          </main>
          {/* <div className="container d-flex justify-content-center mt-5">
