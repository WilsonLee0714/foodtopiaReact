                    ...
                    <div className="blog_footer_icon container d-flex">
                        {this.props.communitys.map(community=>
                            <div key={community.id} className="footer_icon d-flex justify-content-between">
                                <a className="link_black " id="alink1" href={(`${community.facebook}`)}><i className="icon fab fa-facebook col-2"></i></a>
                                <a className="link_black " id="alink2" href={(`${community.instagram}`)}><i className="icon fab fa-instagram col-2"></i></a>
                                <a className="link_black " id="alink3" href={(`${community.google_plus}`)}><i className="icon fab fa-google-plus-g col-2"></i></a>
                                <a className="link_black " id="alink4" href={(`${community.youtube}`)}><i className="icon fab fa-youtube col-2"></i></a>
                            </div>
                        )}
                    </div>
                </div>
