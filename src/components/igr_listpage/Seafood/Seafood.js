    ...
    return (
      ...
      {this.state.seafood.map(food =>
          <div className="sec5_card_item">
            ...
            <h3>
              <Link className="" to={`/ingridient_listpage/seafood_board/${food.product_name}/${food.product_id}/${food.price}/${food.product_img}/${food.spec}`}  key={food.product_name + food.product_id + food.price + food.product_img}>{food.product_name}</Link>
            </h3>
